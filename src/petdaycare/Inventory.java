...
public class Inventory {
    ...
    public int add_inventory() {
        ...
        // Validate Product_ID
        PreparedStatement checkProductStmt = conn.prepareStatement(
        ...
        PreparedStatement checkDuplicateStmt = conn.prepareStatement(
    ...
    public void update_inventory() {
        ...
        try {
            ...
            Scanner sc = new Scanner(System.in);
            System.out.println("Enter Inventory_ID to update: ");
            int inventoryID = sc.nextInt();
            sc.nextLine();
            ...
            System.out.println("Enter new Supply Date (YYYY-MM-DD): ");
    ...
    public int function() {
        ...
        System.out.println("[2] - Update Inventory Record");
        System.out.println("[2] - Delete Inventory Record");
